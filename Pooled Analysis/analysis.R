...
cor.test(exps$practice_prop, exps$prop_correct)
cor.test(exps$practice_prop[exps$format == "MCQ"], exps$prop_correct[exps$format == "MCQ"])
cor.test(exps$practice_prop[exps$format == "SAQ"], exps$prop_correct[exps$format == "SAQ"])
